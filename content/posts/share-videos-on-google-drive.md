...
## 詳細なアクセス権（ファイルのダウンロードなどを禁止する）
通常であれば閲覧者はファイルのダウンロードなどもできるのですが、それを無効にすることができます。適宜活用してください。

Google Drive上の共有したいファイル上で右クリックするとメニューが出てきますので「共有」を選択してください。開いたウィンドウの右下にある「詳細設定」を開くと、より詳細な設定が入力できます。
{{<figure src="6.png" title="共有の設定" class="center">}}


「オーナーの設定」にある「閲覧者（コメント可）と閲覧者のダウンロード、印刷、コピーを無効にします」をチェックすると、ダウンロードが出来ないようにすることが出来ます。
{{<figure src="7.png" title="ダウンロードの禁止などの設定" class="center">}}




## 詳細なアクセス権（アクセスできる有効期限を設定）
ファイルのオーナーは、自分（オーナー）以外のユーザーのアクセス権を設定できますが、その際、そのユーザーに与える権限に有効期限を設定することができます。適宜活用してください。

Google Drive上の共有したいファイル上で右クリックするとメニューが出てきますので「共有」を選択してください。開いたウィンドウの右下にある「詳細設定」を開くと、より詳細な設定が入力できます。

ユーザーの上にカーソルを持ってくるとタイマーのアイコンが表示されますので、それをクリックします。
{{<figure src="8.png" title="共有の詳細設定" class="center">}}

アクセスの有効期限が設定できます。
{{<figure src="9.png" title="アクセスの有効期限を設定" class="center">}}
...
> YouTubeによる動画ファイルの共有は[YouTubeで動画を共有する（動画アップロード）]({{<ref "share-videos-on-google-drive">}})を参考にしてください。

> YouTubeライブ配信は[YouTubeで動画を共有する（Webカメラでライブ配信）]({{<ref "live-streaming-on-youtube">}})を参考にしてください。
